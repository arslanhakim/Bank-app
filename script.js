...
const account2 = {
  ...
  movementsDates: [
    ...
    '2021-12-22T14:43:26.374Z',
    '2021-12-23T18:49:59.371Z',
    '2021-12-24T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const fomattedMov = formatCur(mov, acc.currency, acc.locale);
...
const startLogOutTimer = function () {
  ...
  const tick = function () {
    ...
    //In each call, print the rmaining time to UI
    labelTimer.textContent = `${min}:${sec}`;

    // when time reach to 0 seconds, stop timer and log out user
    if (time === 0) {
      clearInterval(timer);
